  ...
  var t = {
      ...
      313: (t, e, r) => {
        ...
        var i = r(733),
          ...
          o = r(2),
          a = function () {
            function t(t, e, r, n, o, a, u, f, g) {
              this.index = t, this.pageId = e, this.config = r, this.axios = n, this.key1 = o, this.key2 = a, this.key3 = u, this.baseUrl = f, this.pageIndex = g, this.pageConfig = this.config.FileLinkInfo.PageLinkInfoList[g].Page;
              for (var c = this.pageConfig.NS, l = this.pageConfig.PS, d = this.pageConfig.RS, v = 47, p = 0; p < this.pageId.length; p++) v += this.pageId.charCodeAt(p);
              ...
              var _ = 255 & v;
              _ |= _ << 8, _ |= _ << 16, this.B0A = v % i.default.b4v, this.B0J = (_ ^ s(o) ^ c) >>> 0, this.B0K = (_ ^ s(a) ^ l) >>> 0, this.B0n = (_ ^ s(u) ^ d) >>> 0, this.b8A = this.pageConfig.BlockWidth, this.b6V = this.pageConfig.BlockHeight
            }
            return t.prototype.getImage = async function (t) {
              let e = n.default(this.pageId, this.key1, this.key2, this.key3, this.pageIndex);
              ...
              return r.includes("bookwalker.jp") && 1 === this.index ? i : new o.default(i, this, this.pageConfig.Size).decode()
            }, t
          }();
      ...
      791: (t, e, r) => {
        ...
        e.__esModule = !0, e.default = function (t, e, r) {
          var o = t.b8A,
            ...
            M = (w - B) / c % g,
            I = [];
          m.b9es(M, B), m.B0o(h ^ s ^ u);
          var S = m.b4K(65536) + 65536 * m.b4K(65536) + 4294967296 * m.b4K(512),
            x = 4294967296 * l + h,
            C = 4294967296 * d + s,
            W = 4294967296 * f + u,
            P = i.default(S, x, C, W),
            ...
            N = 0,
            z = l * d * 2;
          return K(N, z, o, a), K(N = z, z += 2, v, p), K(N = z, z += 2 * l, o, p), K(N = z, z += 2 * d, v, a), I
        }
      },
      733: (t, e) => {
        "use strict";
      ...
      46: (t, e, r) => {
        ...
        function h(t, e, r, i, n, o, a) {
          for (var h = void 0, s = void 0, u = void 0, f = o, g = a, c = i, l = n, d = 0, v = 0; f + g > 0;) {
            var p = -1;
            if ((h = t(f + g)) < f) {
              if (h < c) {
                for (s = v; s > 0 && !(d >= e[s + p]); s--);
                for (u = v + g; u < a && !(d >= e[u]); u++);
                r[d] = t(u - s) + s, d++, c--
              } else {
                for (s = v; s > 0 && !(d + f <= e[s + p]); s--);
                for (u = v + g; u < a && !(d + f <= e[u]); u++);
                r[d + f + p] = t(u - s) + s
              }
              f--
            } else {
              if (h - f < l) {
                ...
                for (s = d; s > 0 && !(v + g <= r[s + p]); s--);
                for (u = d + f; u < o && !(v + g <= r[u]); u++);
                e[v + g + p] = t(u - s) + s
              }
              g--
            }
        ...
        e.__esModule = !0, e.default = function (t, e, r, s) {
          ...
          var I = u.b4K(65536) | u.b4K(65536) << 16,
            S = c >>> 16,
            x = l >>> 16;
          y = (y ^ I) >>> 0, k = (k ^ I) >>> 0, m = (m ^ I) >>> 0;
          var C = (_ = _ >>> 16 ^ u.b4K(512)) % p,
            W = (_ - C) / p % v;
          u.b9es(W, C), u.B0o(y);
          var P = n(M, S * x);
          u.B0o(k);
          ...
          var L = n(M, S),
            ...
            U = [],
            X = [];
          return h(M, X, U, z, j, S, x),
            function (t, e, r, i, n, o, a, h, s, u, f, g, c) {
              for (var l = [], d = t + 1, v = e + 1, p = d << 1, b = v << 1, _ = 0; _ < t; _++)
                for (var y = 0; y < e; y++) {
                  var k = r[_ + y * t],
                    ...
                    M = S < a[m] ? S : S + d,
                    I = m < o[S] ? m : m + v;
                  l.push(I * p + w), l.push(M * b + B)
                }
              for (l.push(s * p + g), l.push(h * b + c), _ = 0; _ < t; _++) {
                var S;
                w = _ < g ? _ : _ + d, M = (S = i[_]) < h ? S : S + d, l.push(o[S] * p + w), l.push(M * b + u[_])
              }
              for (y = 0; y < e; y++) B = y < c ? y : y + v, I = (m = n[y]) < s ? m : m + v, l.push(I * p + f[y]), l.push(a[m] * b + B);
              return l
            }(S, x, P, L, H, U, X, z, j, $, A, K, N)
        }
      },
      188: (t, e) => {
        "use strict";
        e.__esModule = !0, e.default = function (t, e, r, o, a) {
          var h = {
              B0G: t,
              url: t + `/${a}.jpeg`,
              B0H: ".jpeg",
          ...
          return "string" == typeof s.configuration["file-name-version"] ? h.B0G + "/" + function (t) {
            ...
            for (var g = 3, c = (e.fileName.length << 1) + o + o; c < 256; g++) c += o;
            for (var l = 1670739, d = 1282576, v = 2237221, p = 1 + r.length << 1, b = 0, _ = 0; _ < g; _++, p = 0)
              for (; p < o;) {
                var y = 435 * (v ^= a[p++] ^ t.b9W[b++]),
                  k = 435 * d + ((7 & v) << 18) + (y >>> 22),
                  m = 435 * l + ((3 & d) << 19) + ((4194296 & v) >>> 3) + (k >>> 21);
                v = 4194303 & y, d = 2097151 & k, l = 2097151 & m, b >= t.b9W.length && (b = 0)
              }
            var w = new Array(16);
            for (p = 0; p < w.length; p += 2) switch (p) {
              case 0:
      ...
      10: (t, e, r) => {
        ...
        e.__esModule = !0, t.exports = {
          init: function (t, e, r, n, o, a, h, s) {
            return r.FileLinkInfo.PageLinkInfoList.map(((u, f) => new i.default(t, e, r, n, o, a, h, s, f)))
          }
        }
      }
    },
